...
class FetchProductsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $controller->index('http://localhost/woocommerce','ck_ee434dbfe8fe80e4fbd761c2c192eb0f21ea90e4','cs_265edc200e7ab5d662953e6b9f553abef4d7946d','accoaltinyildizclassics',22,4,5,19);
        Log::info('Çekti');
    }
}
