    ...
    var createDateRangePickers = function () {
        ...
        elements.map(function (element) {
            ...
            if (url.searchParams.get('start') && url.searchParams.get('end')) {
                display.innerHTML = localStorage.getItem('date2');
            } else {
                display.innerHTML = localStorage.getItem('date');
            }
            ...
            var cb = function (start, end) {
                ...
                if (display) {
                    if (current.isSame(start, "day") && current.isSame(end, "day")) {
                        localStorage.setItem('date', start.locale('tr').format('D MMMM YYYY'));
                    } else {
                        localStorage.setItem('date2', display.innerHTML = start.locale('tr').format('D MMMM YYYY') + ' - ' + end.locale('tr').format('D MMMM YYYY'));
                    }
                }
            ...
            $(element).daterangepicker({
                ...
                locale: {
                    ...
                    weekLabel: 'W',
                    daysOfWeek: ['Pz', 'Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt'],
